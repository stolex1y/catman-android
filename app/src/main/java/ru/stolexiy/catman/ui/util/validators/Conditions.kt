...
class Conditions {
     ...
     * **/
    class RequiredField<T : CharSequence>(private val errorText: String? = "Required field") :
        Condition<T?> {
        constructor(
            context: Context,
    ...
    class TextMaxLength<T : CharSequence?>(
        ...
        constructor(
            ...
            maxLength,
            context.getString(errorText, maxLength)
        )
    ...
    class TextMinLength<T : CharSequence>(
        ...
        constructor(
            ...
            minLength,
            context.getString(errorText, minLength)
        )
    ...
    class TextLength<T : CharSequence>(
        ...
        constructor(
            ...
            textLength,
            context.getString(errorText, textLength)
        )
